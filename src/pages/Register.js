            ...
            <form>
                <div className='test'>
                    ...
                    <div className="second-input">
                        ...
                        <input type="numbers" placeholder="Telephone number" className="name" />
                    </div>
                    <div className="second-input">
                    ...
                    <p className="link">
                        <a href="#">already have an acount?</a><a href="#" style={{ color: "#b71c1c" }}> Login</a>
                    </p>
